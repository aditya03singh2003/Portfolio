  ...
  return (
    <motion.nav
      ...
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
        scrolled ? "bg-[#0c0414]/90 backdrop-blur-md py-3" : "bg-transparent py-5"
      }`}
    >
      <div className="container mx-auto px-4 md:px-8 flex justify-between items-center">
        <Link href="#home" className="text-2xl font-bold text-white" onClick={(e) => scrollToSection(e, "#home")}>
          Aditya<span className="text-purple-500">.</span>
        </Link>
        ...
        <div className="hidden md:flex space-x-8 items-center">
          ...
          <motion.a
            ...
            className="flex items-center gap-2 px-4 py-1.5 border-2 border-purple-500 rounded-md text-white hover:bg-purple-500 transition-colors duration-300"
      ...
      {isOpen && (
        <motion.div
          ...
          className="md:hidden bg-[#0c0414]/95 backdrop-blur-md"
        >
          <motion.div
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
          ...
          >
            ...
            <div className="flex justify-center space-x-6 mt-6">
              <motion.a
                href="https://github.com/aditya03singh2003"
                target="_blank"
                rel="noopener noreferrer"
              ...
              <motion.a
                href="https://www.linkedin.com/in/adityaaa03/"
                target="_blank"
                rel="noopener noreferrer"
                className="text-gray-300 hover:text-white transition-colors duration-300"
                aria-label="LinkedIn"
